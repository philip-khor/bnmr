...
- `get_bnm_stmt_cap_lbl()`: 1.5 Bank Negara Malaysia: Statement of
...
- `get_islm_const_cap()`: 1.29.1a Islamic Banking System : Constituents
  of Capital
...
- `get_islm_inv()`: 1.32 Islamic Banking System: Total Investment
  Account by Type and Holder
...
[`msb1_loans`](https://bnmr.philipscurve.com/reference/msb1_loans.md),
[`msb1_deposits`](https://bnmr.philipscurve.com/reference/msb1_deposits.md)

## Examples

``` r
if (FALSE) get_reserve_money() # \dontrun{}
if (FALSE) get_reserve_money(year = 2010) # \dontrun{}
```
