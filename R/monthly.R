...
#' @export
#' @examples
#' \donttest{islamic_interbank_rate()}
...
#' @export
#' @examples
#' \donttest{usd_interbank_intraday_rate()}
...
#' @export
#' @examples
#' \donttest{kl_usd_reference_rate()}
