# Contributing to bnmr

This outlines how to propose a change to bnmr. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("philip-khor/bnmr", fork = TRUE)`.
...
Please note that the bnmr project is released with a [Contributor Code
of Conduct](https://bnmr.philipscurve.com/CODE_OF_CONDUCT.md). By
